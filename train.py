...
parser.add_argument('--exp', default='test', type=str, help='description to indicate which experiment it is')
best_acc1 = 0


def main():
    args = parser.parse_args()
    args.store_name = '_'.join([args.dataset, args.arch, args.exp])
...
def main_worker(gpu, args):
    ...
    with open(os.path.join(args.root_log, args.store_name, 'args.txt'), 'w') as f:
        f.write(str(args))
    tf_writer = tb.SummaryWriter(log_dir=os.path.join(args.root_log, args.store_name))
